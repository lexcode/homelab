...
- **DNS / AdGuard Home** (LAN resolver / ad blocking) is a separate stack: [`dns/`](../dns/README.md). It defaults the web UI to host port **3005** so it does not fight NPM for `80`/`443` on the same machine.
